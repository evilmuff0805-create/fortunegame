...
export function buildSystemPrompt(): string {
  return [
    ...
    "",
    "[클리셰 회피]",
    "- 닳은 표현 자제: '따뜻한 차 한 잔', '숨을 고르며', '~할 거예요'의 반복 남발.",
    "- 문장 끝맺음을 다양화한다(서술·청유·감탄을 섞어). 매 문장 '~예요/~거예요'로만 끝내지 마라.",
